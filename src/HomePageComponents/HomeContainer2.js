...
const HomeContainer2 = () => {
  return (
    <div className="flex justify-center relative p-6 mt-[8.75rem] mb-[10.625rem] w-full ">
      ...
      />
      <div className="flex flex-col justify-center w-[38.94rem] mt-[5.8125rem] mb-[5rem] p-6 bg-HomeContainer2TextBox  backdrop-blur-3xl rounded-2xl absolute xl:backdrop-blur-sm xl:ml-[40rem]">
